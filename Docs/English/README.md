...
### General
- [Introduction](General/Introduction.md) — Project overview and goals
...
- [Localization](Technical/Localization.md) — Multi-language support
- [Building](Technical/Building.md) — Build, run, and publish instructions
